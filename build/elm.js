...
var author$project$Types$example = {contents: '', filename: 'nothing.mscx'};
...
var author$project$State$init = function (_n0) {
	return _Utils_Tuple2(
		{
			bloqueado: false,
			escala: {_do: 0, dos: 1, fa: 5, fas: 6, la: 9, las: 10, mi: 4, nombre: 'Cromática', re: 2, res: 3, si: 11, sol: 7, sols: 8},
			escalaAnterior: {_do: 0, dos: 1, fa: 5, fas: 6, la: 9, las: 10, mi: 4, nombre: 'Cromática', re: 2, res: 3, si: 11, sol: 7, sols: 8},
			id: 'ScoreInputId',
			mScore: elm$core$Maybe$Just(author$project$Types$example)
		},
...
var author$project$Types$ScoreRead = function (a) {
	return {$: 'ScoreRead', a: a};
};
var author$project$State$subscriptions = function (model) {
	return author$project$Ports$fileContentRead(author$project$Types$ScoreRead);
};
...
var author$project$State$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'ScoreRead':
				var data = msg.a;
				var newScore = {contents: data.contents, filename: data.filename};
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							mScore: elm$core$Maybe$Just(newScore)
						}),
					elm$core$Platform$Cmd$none);
			case 'Preescalar':
				var nombre = msg.a;
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{
							bloqueado: true,
							escala: {_do: zero, dos: one, fa: five, fas: six, la: nine, las: ten, mi: four, nombre: nombre, re: two, res: three, si: eleven, sol: seven, sols: eigth}
						}),
					elm$core$Platform$Cmd$none);
			case 'Introducir':
				var s = msg.a;
			...
			default:
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{bloqueado: false, escala: model.escalaAnterior}),
					elm$core$Platform$Cmd$none);
		}
	});
var author$project$Functions$getDifference = F2(
	function (model, k) {
		var arr = (!k) ? model.escala._do : ((k === 1) ? model.escala.dos : ((k === 2) ? model.escala.re : ((k === 3) ? model.escala.res : ((k === 4) ? model.escala.mi : ((k === 5) ? model.escala.fa : ((k === 6) ? model.escala.fas : ((k === 7) ? model.escala.sol : ((k === 8) ? model.escala.sols : ((k === 9) ? model.escala.la : ((k === 10) ? model.escala.las : model.escala.si))))))))));
		return arr - k;
	});
...
var author$project$Functions$depitch = function (model) {
	return A2(
		elm$regex$Regex$replace,
		A2(
			elm$core$Maybe$withDefault,
			elm$regex$Regex$never,
			elm$regex$Regex$fromString('<pitch>[0-9]+</pitch>')),
		function (_n0) {
			var match = _n0.match;
			return '<pitch>' + (elm$core$String$fromInt(
				function (n) {
					return n + A2(
						author$project$Functions$getDifference,
						model,
						A2(
							F2(
								function (b, a) {
					...
					A2(
						...
						elm$core$String$toInt(
							A3(elm$core$String$slice, 7, -8, match))))) + '</pitch>');
		});
};
var author$project$Functions$tpc2note = function (k) {
	return (k === 2) ? 0 : ((k === 9) ? 1 : ((k === 4) ? 2 : ((k === 11) ? 3 : ((k === 6) ? 4 : ((k === 1) ? 5 : ((k === 8) ? 6 : ((k === 3) ? 7 : ((k === 10) ? 8 : ((k === 5) ? 9 : ((!k) ? 10 : 11))))))))));
};
var author$project$Functions$tpcCreciente = function (a) {
	return A2(elm$core$Basics$modBy, 12, a + 7) + 12;
};
var author$project$Functions$tpcDecreciente = function (a) {
	return A2(elm$core$Basics$modBy, 12, a - 7) + 12;
};
var elm$core$Basics$compare = _Utils_compare;
var author$project$Functions$tpcChange = F2(
	function (a, b) {
		tpcChange:
		while (true) {
			var _n0 = A2(elm$core$Basics$compare, b, 0);
			switch (_n0.$) {
				case 'EQ':
					return a;
				case 'GT':
					var $temp$a = author$project$Functions$tpcCreciente(a),
						$temp$b = b - 1;
					a = $temp$a;
					b = $temp$b;
					continue tpcChange;
				default:
					var $temp$a = author$project$Functions$tpcDecreciente(a),
						$temp$b = b + 1;
					a = $temp$a;
					b = $temp$b;
					continue tpcChange;
...
var author$project$Functions$detpc = function (model) {
	return A2(
		elm$regex$Regex$replace,
		A2(
			elm$core$Maybe$withDefault,
			elm$regex$Regex$never,
			elm$regex$Regex$fromString('<tpc>[0-9]+</tpc>')),
		function (_n0) {
			var match = _n0.match;
			return '<tpc>' + (elm$core$String$fromInt(
				function (n) {
					return A2(
						author$project$Functions$tpcChange,
						n,
						A2(
							author$project$Functions$getDifference,
							model,
							author$project$Functions$tpc2note(
								A2(
									F2(
										function (b, a) {
											return A2(
					...
					A2(
						...
						21,
						elm$core$String$toInt(
							A3(elm$core$String$slice, 5, -6, match))))) + '</tpc>');
		});
};
...
var author$project$Styles$textStyle = function (tam) {
	return _List_fromArray(
		[
			A2(elm$html$Html$Attributes$style, 'font-family', 'calibri'),
			A2(elm$html$Html$Attributes$style, 'font-size', tam)
		]);
};
...
var author$project$Info$informacion = A2(
	elm_explorations$markdown$Markdown$toHtml,
	_Utils_ap(
		author$project$Styles$textStyle('20px'),
		_List_fromArray(
			[
				A2(elm$html$Html$Attributes$style, 'text-align', 'justify'),
	...
	author$project$Info$texto);
var author$project$Styles$back = '#F9F9FF';
var author$project$Styles$generalStyle = _List_fromArray(
	[
		A2(elm$html$Html$Attributes$style, 'text-align', 'center'),
		A2(elm$html$Html$Attributes$style, 'background-color', author$project$Styles$back),
		A2(elm$html$Html$Attributes$style, 'overflow', 'auto')
	]);
var author$project$Styles$bold = '#BBBBFF';
var author$project$Styles$suave = '#EEEEFF';
...
var author$project$Styles$aStyle = F2(
	function (_this, ref) {
		return _Utils_ap(
			_List_fromArray(
				[
...
var author$project$View$descargar = function (model) {
	var scoreDownload = function () {
		var _n0 = model.mScore;
		if (_n0.$ === 'Just') {
			var i = _n0.a;
			return i;
			...
			[
				...
				_List_fromArray(
					[
						...
						elm$html$Html$Attributes$href('data:text/plain;charset=utf-8,' + scoreDownload.contents),
						elm$html$Html$Attributes$download(scoreDownload.filename)
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								elm$html$Html$text('Descargar')
							]))
					]))
			]));
};
var author$project$Styles$cellStyle = _List_fromArray(
	[
		A2(elm$html$Html$Attributes$style, 'text-align', 'center'),
		A2(elm$html$Html$Attributes$style, 'width', '50px'),
		A2(elm$html$Html$Attributes$style, 'max-width', '50px'),
...
var author$project$Types$Fas = {$: 'Fas'};
var author$project$Types$La = {$: 'La'};
var author$project$Types$Las = {$: 'Las'};
var author$project$Types$Mi = {$: 'Mi'};
var author$project$Types$Re = {$: 'Re'};
var author$project$Types$Res = {$: 'Res'};
var author$project$Types$Si = {$: 'Si'};
...
var author$project$View$recuadrin = F3(
	function (b, s, n) {
		return A2(
			elm$html$Html$td,
			_List_Nil,
			_List_fromArray(
				[
					...
					elm$html$Html$input,
					_Utils_ap(
						author$project$Styles$squarefieldStyle('30px'),
						_List_fromArray(
							[
								elm$html$Html$Attributes$readonly(b),
								elm$html$Html$Attributes$placeholder(s),
								elm$html$Html$Events$onInput(
								author$project$Types$Introducir(n))
							])),
					_List_Nil)
				]));
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								A3(author$project$View$recuadrin, bloqueado, '0', author$project$Types$Do),
								A3(author$project$View$recuadrin, bloqueado, '1', author$project$Types$Dos),
								A3(author$project$View$recuadrin, bloqueado, '2', author$project$Types$Re),
								A3(author$project$View$recuadrin, bloqueado, '3', author$project$Types$Res),
								A3(author$project$View$recuadrin, bloqueado, '4', author$project$Types$Mi),
								A3(author$project$View$recuadrin, bloqueado, '5', author$project$Types$Fa),
								A3(author$project$View$recuadrin, bloqueado, '6', author$project$Types$Fas),
								A3(author$project$View$recuadrin, bloqueado, '7', author$project$Types$Sol),
								A3(author$project$View$recuadrin, bloqueado, '8', author$project$Types$Sols),
								A3(author$project$View$recuadrin, bloqueado, '9', author$project$Types$La),
								A3(author$project$View$recuadrin, bloqueado, '10', author$project$Types$Las),
								A3(author$project$View$recuadrin, bloqueado, '11', author$project$Types$Si)
							]))
					]))
			]));
};
var author$project$Styles$fileStyle = _List_fromArray(
	[
		...
		A2(elm$html$Html$Attributes$style, 'background-position', '95%'),
		A2(elm$html$Html$Attributes$style, 'border', '1px solid #88888'),
		A2(elm$html$Html$Attributes$style, 'border-radius', '20px 20px 20px 20px'),
		A2(elm$html$Html$Attributes$style, 'color', 'black'),
...
var author$project$View$examinar = function (model) {
	return A2(
		elm$html$Html$input,
		_Utils_ap(
			author$project$Styles$fileStyle,
			_List_fromArray(
				[
					A2(elm$html$Html$Attributes$style, 'margin-top', '50px'),
					elm$html$Html$Attributes$type_('file'),
					elm$html$Html$Attributes$id(model.id),
					elm$html$Html$Attributes$accept('.mscx'),
					A2(
					elm$html$Html$Events$on,
					'change',
					elm$json$Json$Decode$succeed(author$project$Types$ScoreSelected))
				])),
		_List_Nil);
};
...
var author$project$Types$Preescalar = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
								...
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return {$: 'Preescalar', a: a, b: b, c: c, d: d, e: e, f: f, g: g, h: h, i: i, j: j, k: k, l: l, m: m};
												};
											};
										};
									};
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$name('Escala'),
								elm$html$Html$Events$onClick(
								author$project$Types$Preescalar('Pentafónica')(0)(0)(2)(2)(4)(4)(7)(7)(7)(9)(9)(12))
							]),
						_List_Nil),
						elm$html$Html$text(' Pentafónica')
					])),
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$name('Escala'),
								elm$html$Html$Events$onClick(
								author$project$Types$Preescalar('Hexafónica')(0)(0)(2)(2)(4)(4)(6)(6)(8)(8)(10)(10))
							]),
						_List_Nil),
						elm$html$Html$text(' Hexafónica')
					]))
			]),
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Attributes$name('Escala'),
								elm$html$Html$Events$onClick(
								author$project$Types$Preescalar('Heptafónica')(0)(0)(2)(2)(4)(5)(5)(7)(7)(9)(9)(11))
							]),
						_List_Nil),
						elm$html$Html$text(' Heptafónica')
					])),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				A2(elm$html$Html$br, _List_Nil, _List_Nil),
				A2(
					...
					[
						...
						_List_fromArray(
							[
								elm$html$Html$Attributes$type_('radio'),
								elm$html$Html$Attributes$name('Escala'),
								elm$html$Html$Attributes$checked(!bloqueado),
								elm$html$Html$Events$onClick(author$project$Types$VolverAEscalaAnterior)
							]),
						_List_Nil),
						elm$html$Html$text(' ')
					])),
				...
				elm$html$Html$input,
				_Utils_ap(
					author$project$Styles$squarefieldStyle('150px'),
					_List_fromArray(
						[
							elm$html$Html$Attributes$placeholder('Cromática'),
							elm$html$Html$Events$onInput(author$project$Types$CambiarNombreEscala),
							elm$html$Html$Attributes$readonly(bloqueado)
						])),
				_List_Nil)
			]));
};
	...
	return A2(
		...
		_List_fromArray(
			[
				A2(
				elm$html$Html$div,
				author$project$Styles$generalStyle,
				_List_fromArray(
					[
...
var author$project$Main$main = elm$browser$Browser$document(
	{init: author$project$State$init, subscriptions: author$project$State$subscriptions, update: author$project$State$update, view: author$project$View$view});
_Platform_export({'Main':{'init':author$project$Main$main(
	elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.0"},"types":{"message":"Types.Msg","aliases":{"Ports.ScorePortData":{"args":[],"type":"{ contents : String.String, filename : String.String }"}},"unions":{"Types.Msg":{"args":[],"tags":{"ScoreSelected":[],"ScoreRead":["Ports.ScorePortData"],"Introducir":["Types.Nota","String.String"],"Preescalar":["String.String","Basics.Int","Basics.Int","Basics.Int","Basics.Int","Basics.Int","Basics.Int","Basics.Int","Basics.Int","Basics.Int","Basics.Int","Basics.Int","Basics.Int"],"CambiarNombreEscala":["String.String"],"VolverAEscalaAnterior":[]}},"Types.Nota":{"args":[],"tags":{"Do":[],"Dos":[],"Re":[],"Res":[],"Mi":[],"Fa":[],"Fas":[],"Sol":[],"Sols":[],"La":[],"Las":[],"Si":[]}},"Basics.Int":{"args":[],"tags":{"Int":[]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});}(this));